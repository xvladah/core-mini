...
final class Barcode39 {
	 ...
	 */
	private const string f2B = "11";
    private const string f2W = "00";
    private const string f2b = "10";
    private const string f2w = "01";
	 ...
	 */
	public int $barcode_bar_thick = 3;
	 ...
	 */
	public array $barcode_bg_rgb = [255, 255, 255];
	 ...
	 */
	public int $barcode_text_size = 3;
	 ...
	 */
	public bool $barcode_use_dynamic_width = true;
	 ...
	 * @return bool
	 */
	public function draw(?string $filename = null): bool
    {
